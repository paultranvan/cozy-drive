...
export const updateSettingStatus = async (setting, count, newLastDate) => {
  log('info', `Update setting for last date ${newLastDate}`)
  ...
  /*
  if(!newSetting.perf) {
    newSetting.perf = perf
  } else {
    newSetting.perf = newSetting.perf  + perf
  }*/
